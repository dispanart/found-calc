import { handleCommercialWorkspaceProjectRequest } from "@/lib/workspace/commercial-http";
...
const handle = async (method: "GET" | "PATCH" | "DELETE", request: Request, context: RouteContext) => {
  try {
    ...
    return await handleCommercialWorkspaceProjectRequest(method, request, id, getWorkspaceRouteServices());
